...
.exe-single-page .package-header .package-title {
    padding-left: 32px;
...
/* Teacher mode visual indicator */
.exe-content article.box.teacher-only {
    border: 2px solid #FFB74D;
}

.exe-content .box.teacher-only header {
  border-bottom-color: #002702;
}

.exe-content article.box .idevice_node.teacher-only {
    border: 2px solid #FFB74D;
    border-radius: 12px;
    padding: 16px;
}

#node-content article.box.exe-teacher-highlight,
#node-content .idevice_node.exe-teacher-highlight {
...
.active .active.daddy {
    background: #ffb74d url(img/arrow_color.svg) no-repeat right 16px center /
        22px !important;
}
.active .daddy {
    background: #ffeba1 url(img/arrow_down_color.svg) no-repeat right 16px
        center / 22px !important;
}
#siteNav .current-page-parent > .daddy {
    background: #ffeba1 url(img/arrow_color.svg) no-repeat right 16px center /
        22px !important;
    margin-bottom: 6px;
}
...
.daddy:hover {
    background: #e49929 url(img/arrow_down_color.svg) no-repeat right 16px
        center / 22px !important;
}
.active.daddy:hover {
    background: #e49929 url(img/arrow_color.svg) no-repeat right 16px center /
        22px !important;
}
...
@media (max-width: 750px) {
    ...
    button#siteNavToggler {
        background: #fff url(img/menu_open_black.svg) no-repeat 12px center /
            32px;
    }
    body.siteNav-off button#siteNavToggler {
